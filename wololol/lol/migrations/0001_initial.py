...
class Migration(migrations.Migration):
    ...
    operations = [
        migrations.CreateModel(
            name='history',
            fields=[
                ('summonerId', models.TextField(serialize=False, verbose_name='id del summoner', primary_key=True)),
        ...
        migrations.CreateModel(
            name='league',
            fields=[
                ('leagueid', models.TextField(serialize=False, verbose_name='id de la liga', primary_key=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('summonerId', models.TextField(serialize=False, verbose_name='id del summoner', primary_key=True)),
                ('mostPlayedChampId', models.TextField(verbose_name='icono del pj mas usado')),
                ...
                ('mostPlayedChampMatchesLoseCount', models.TextField(verbose_name='cantidad de derrotas')),
                ('mostPlayedChampKdaRatio', models.TextField(verbose_name='kda ratio con este Pj')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('summonerId', models.TextField(serialize=False, verbose_name='id del summoner', primary_key=True)),
                ('summonerRegion', models.TextField(verbose_name='region del summoner')),
                ('summonerImg', models.TextField(verbose_name='imagen del summoner')),
                ('summonerName', models.TextField(verbose_name='nombre del summoner')),
                ...
                ('summonerKdaratio', models.TextField(verbose_name='kda ratio general')),
            ],
        ),
    ]
